        ...
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data" action="/question">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" id="formGroupQuestionTitleInput"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="award_amount" class="form-control" id="awardamount"
                        placeholder="Award amount" required>
                </div>
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="description" id="questionDescriptionTextarea"
                        placeholder=" Question description i.e question content." required></textarea>
                </div>
                <div class="form-group">
